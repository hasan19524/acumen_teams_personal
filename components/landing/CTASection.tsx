        ...
        <ScrollReveal>
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Thousands of teams use Acumen Teams to communicate clearly, manage
              work, and stay organized — all in one place.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-[var(--heading)] px-8 py-6 text-base lg:text-lg rounded-full font-semibold transition-all hover:scale-105 hover:shadow-[0_20px_40px_rgba(6,182,212,0.25)] group"
                >
                  Start Free Trial
